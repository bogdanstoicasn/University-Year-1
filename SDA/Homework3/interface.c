...
int command_typo_insert(char string[MAX_STRING_SIZE], char word[MAX_STRING_SIZE])
{   
...
int command_typo_remove(char string[MAX_STRING_SIZE], char word[MAX_STRING_SIZE])
{   
    char *token = strtok(string, " ");
	token = strtok(NULL, " ");
...
int command_typo_correct(char string[MAX_STRING_SIZE], char word[MAX_STRING_SIZE], int *n)
{   
	char *token = strtok(string, " ");
	token = strtok(NULL, " ");
...
int command_typo_complete(char string[MAX_STRING_SIZE], char word[MAX_STRING_SIZE], int *n)
{   
	char *token = strtok(string, " ");
	token = strtok(NULL, " ");
